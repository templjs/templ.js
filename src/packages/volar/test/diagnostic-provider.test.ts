...
describe('Package: volar', () => {
  describe('Domain: validation', () => {
    describe('Class: DiagnosticProvider', () => {
      describe('DiagnosticProvider', () => {
        ...
        it('reports unclosed statement delimiter', () => {
          ...
          expect(
            diagnostics.some((diag) => diag.code === 'templjs.unclosedStatementDelimiter')
          ).toBe(true);
        });
        ...
        it('reports unclosed expression delimiter', () => {
          ...
          expect(
            diagnostics.some((diag) => diag.code === 'templjs.unclosedExpressionDelimiter')
          ).toBe(true);
        });
