...
id: work-item:052-extraction-tests
title: '052: Write Extraction Tests and Documentation'
summary: Write Extraction Tests and Documentation
type: work-item
subtype: task
lifecycle: draft
status: proposed
...
links:
  ...
  evidence:
    - '[[record-20260514-223855-052-extraction-tests]]'
---
...
- `depends_on`: [[work-item-051-extraction-cli]]
