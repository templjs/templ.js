...
id: work-item:050-extraction-validation
title: '050: Add Schema-Guided Extraction and Validation'
summary: Add Schema-Guided Extraction and Validation
type: work-item
subtype: story
lifecycle: draft
status: proposed
...
links:
  ...
  evidence:
    - '[[record-20260514-223855-050-extraction-validation]]'
---
...
- `depends_on`: [[work-item-049-extraction-engine]]
