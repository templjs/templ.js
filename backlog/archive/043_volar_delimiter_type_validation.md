...
notes:
  - timestamp: 2026-03-08T00:00:00Z
    note: |
      WI-043 already fixed in PR #23 commit ce96fda:
      - Added non-empty string validation in resolveDelimiters()
      - Validates delimiter values before overlap checks
      - Uses Set-based validation to ensure distinctness
      - Test coverage: src/packages/volar/test/template-delimiters.test.ts
      - All delimiter tests pass (4/4 passing)
      - Change implemented in src/packages/volar/src/template-delimiters.ts lines 30-38
---
