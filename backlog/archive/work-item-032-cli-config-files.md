...
id: work-item:032-cli-config-files
title: '32: Add CLI Config File Support (.templjs.json)'
summary: Add CLI Config File Support (.templjs.json)
type: work-item
subtype: story
lifecycle: inactive
status: closed
...
links:
  ...
  evidence:
    - '[[record-032-cli-config-files-evidence-1]]'
    - '[[record-032-cli-config-files-evidence-2]]'
    - '[[record-032-cli-config-files-evidence-3]]'
---
