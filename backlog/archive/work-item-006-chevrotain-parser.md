...
id: work-item:006-chevrotain-parser
title: '6: Implement Chevrotain Parser (AST Generation)'
summary: Implement Chevrotain Parser (AST Generation)
type: work-item
subtype: story
lifecycle: inactive
status: closed
...
links:
  ...
  evidence:
    - '[[record-006-chevrotain-parser-evidence-1]]'
    - '[[record-006-chevrotain-parser-evidence-2]]'
---
