...
id: work-item:055-bug-no-md-lang-server-support
title: '055: Markdown syntax highlighting and linting not working for md.tpl files'
summary: Markdown syntax highlighting and linting not working for md.tpl files
type: work-item
subtype: bug
lifecycle: inactive
status: closed
...
links:
  ...
  evidence:
    - '[[record-055-bug-no-md-lang-server-support-evidence-1]]'
---
...
- [x] Split unresolved host-language activation validation follow-up into [[work-item-089-md-host-language-activation-validation-matrix]]
...
- [x] Remaining host-language activation edge cases are tracked in [[work-item-089-md-host-language-activation-validation-matrix]] for local validation matrix completion
...
- Revisit host-language activation in [[work-item-089-md-host-language-activation-validation-matrix]]: baseline `.md.tpl` behavior is covered, but deterministic local host-language activation validation is still required across `.md.tpl`, `.md.templ`, and `.md.tmpl` matrix scenarios.

## Next Steps

- Remaining host-language recognition validation and edge-case resolution are tracked under [[work-item-089-md-host-language-activation-validation-matrix]].
