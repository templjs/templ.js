...
id: work-item:016-extension-tests
title: '16: Write VS Code Extension Activation & Server Tests (MVP)'
summary: Write VS Code Extension Activation & Server Tests (MVP)
type: work-item
subtype: task
lifecycle: inactive
status: closed
...
links:
  ...
  evidence:
    - '[[record-016-extension-tests-evidence-1]]'
---
...
- `depends_on`: [[work-item-013-syntax-highlighting]]
- `depends_on`: [[work-item-014-diagnostics]]
- `depends_on`: [[work-item-015-intellisense]]
