...
notes:
  - timestamp: 2026-03-17T00:00:00Z
    note: |
      Created from the parser-authority planning session for Volar and VS Code authoring.
      Planning guardrails landed alongside this proposal in:
      - `src/packages/volar/src/AGENTS.md`
      - `src/packages/core/src/AGENTS.md`
      - `src/extensions/vscode/src/AGENTS.md`
---
