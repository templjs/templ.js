...
| `concat`   | `concat(arrayValue, ...arrays)`  | Concatenate one or more arrays.     | `[1,2] \| concat([3,4], [5]) -> [1,2,3,4,5]`  |
...
| `reduce` | `reduce(arrayValue)` | Returns input unchanged. | `[1,2,3] \| reduce -> [1,2,3]` |
