...
Also updates semantify profile projections to include the new
`profileVersion` provenance signal, ensuring downstream consumers can detect
profile-backed updates consistently.
